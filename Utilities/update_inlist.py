...
# This is my own (ejetzer). A simpler function.
def replace(old, new):
    with open('inlist_ns_h', 'r') as inlist_ns_h:
        content = inlist_ns_h.read()
    content = content.replace(old, new)
    with open('inlist_ns_h', 'w') as inlist_ns_h:
        inlist_ns_h.write(content)
